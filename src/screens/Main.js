...
import {Button,Linking,Text,View,Image,TouchableOpacity} from 'react-native'
...
const Main = ({navigation}) => {
    return(
        <View>
            ...
            >
            <Image source={require('../img/Cafe.png')}
                    style={{width:"100%",height:"100%"}}
                />
            ...
            >
                 <Image source={require('../img/loyalty.jpg')}
                    style={{height:105,
                        width:105,
                        borderRadius:105/2,}}
                />
                ...
                style={{color:"white",fontSize:14,marginTop:1}}>
                    Loyalty
                </Text>
            </TouchableOpacity>
            <Text
            ...
            >
            <Image source={require('../img/target.png')}
            ...
            >
            <Image source={require('../img/Goals.png')}
                    style={{width:"100%",height:"100%"}}
                />
            <Text                
            style={{
            ...
            >
            <Image source={require('../img/Challenge.png')}
            ...
            >
            <Image source={require('../img/Tips.png')}
